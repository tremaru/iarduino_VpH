//	Библиотека для преобразования напряжения с щупа pH-метра в кислотность жидкости: https://iarduino.ru/shop/Sensory-Datchiki/schup-ph-metra-bnc.html
//  Версия: 1.0.0
//  Последнюю версию библиотеки Вы можете скачать по ссылке: https://iarduino.ru/file/635.html
